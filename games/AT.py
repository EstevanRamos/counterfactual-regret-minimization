from common.AT_constants import CHECK, BET, CALL, FOLD, A, CHANCE, RESULTS_MAP
import random
...
class ATRootChanceGameState(GameStateBase):

    def __init__(self, actions):
        super().__init__(parent = None, to_move = CHANCE, actions = actions)
        self.children = {
            cards: ATPlayerMoveGameState(
...
class ATPlayerMoveGameState(GameStateBase):
